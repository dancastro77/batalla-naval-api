...
/**
 * Clase que representa el resumen del tablero que se le pasa al jugador rival al inicio del juego.
 * @author danilo
...
public class ResumenTablero 
{
	...
	public ResumenTablero( int[] casillasOcupadasFila, int[] casillasOcupadasColumna ) 
	{
		...
		System.arraycopy( 
		        casillasOcupadasFila, 0, this.casillasOcupadasFila, 0, casillasOcupadasFila.length );
        this.casillasOcupadasColumna = new int[casillasOcupadasColumna.length];
        System.arraycopy( 
                casillasOcupadasColumna, 0, this.casillasOcupadasColumna, 0, casillasOcupadasColumna.length );
	}
